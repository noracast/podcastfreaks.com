...
// ハイドレーションが失敗し、/episodes/ では HierarchyRequestError が出て
...
//
// 日付ライブラリは dayjs。moment はブラウザへ送る量が大きく、
// scripts/ 側も素の Date で足りたので外した。
...
// 英語で出したいところのぶん。ja と同じ理由で中身を受け取る
...
// 英語で書きたいとき（/episodes の heatmap の月名）。日付の扱いは jst と同じ
export const jstEn = (value) => jst(value).locale(en)
