<template>
  <div class="root">
    ...
    <h3>OPMLダウンロード</h3>
    <p>トップページの「Download OPML」ボタンを押すと、そのとき一覧に出ている番組がOPMLファイルになります。検索やHostingでの絞り込み、並べ替えの結果がそのまま書き出す中身になるので、絞り込んでから押せば必要な番組だけを取り出せます。書き出す件数はボタンの括弧内に出ています。<br>MacとiOSをご使用の場合は、MacからAirDropで送るとiOS側でPodcastアプリを選択し、簡単に登録することができます。</p>
    <h3>音声の再生について</h3>
