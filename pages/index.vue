...
.root {
  ...
  & thead {
    /* 文字も面と同じように透かす。下を通る中身がぼけて透ける帯なのに、
       文字だけ不透明な灰色だと、帯の上に別の紙が乗っているように見えた
       （紫のボタンが真下に来たときが分かりやすい）。
       黒の 20% にすると、白い地の上では今までと同じ #ccc、色が透けている
       ところではその色を濃くしただけになり、帯の一部として見える。
       灰色そのものを半透明にする手（rgba(204,204,204,...)）も試したが、
       白い地の上で薄くなりすぎて読めなかった */
